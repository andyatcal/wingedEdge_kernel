...
class Selection {
    ...
    void selectVertex(Mesh & mesh, GLint hits, GLuint *names, GLdouble posX, GLdouble posY, GLdouble posZ)
    {
        if(hits > 0) {
            int minimumDepth = INT_MAX;
            int minimumDepthIndex = INT_MAX;
    ...
    void selectWholeBoarder(Mesh & mesh, GLint hits, GLuint *names, GLdouble posX, GLdouble posY, GLdouble posZ)
    {
        if(hits > 0) {
            int minimumDepth = INT_MAX;
            int minimumDepthIndex = INT_MAX;
    ...
    void selectPartialBoarderPoints(Mesh & mesh, GLint hits, GLuint *names, GLdouble posX, GLdouble posY, GLdouble posZ)
    {
        if(hits > 0) {
            int minimumDepth = INT_MAX;
            int minimumDepthIndex = INT_MAX;
